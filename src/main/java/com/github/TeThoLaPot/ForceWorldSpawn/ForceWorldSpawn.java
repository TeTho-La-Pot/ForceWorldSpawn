...
@Mod(ForceWorldSpawn.MOD_ID)
public class ForceWorldSpawn {
    public static final String MOD_ID = "force_world_spawn";
    private static final Logger LOGGER = LogUtils.getLogger();

    public ForceWorldSpawn(FMLJavaModLoadingContext context) {
